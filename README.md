...
- **Node.js** (for the UI).
- **Python 3.8+** (for the CORS Relay).

### 2. Setup the Relay Backend
The relay allows the safe cross-origin communication between the UI and your remote Containerlab instance.
...
3. **Customize**: Click a node to open the **Node Properties** panel and override the Docker image if needed.
4. **Deploy**: Hit **Deploy** and watch the real-time logs in the **Lab Console**.

## 🛠️ Tech Stack

- **Frontend**: React, React Flow, Zustand, Tailwind CSS, Lucide Icons.
- **Backend Relay**: Python, FastAPI.
